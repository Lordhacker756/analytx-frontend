...
export const GoogleSpreadsheet = () => {
    ...
    const handleSubmit = (event) => {
        ...
        fetch('http://localhost:8080/submit-google-spreadsheet', {
            method: 'POST',
            headers: {
        ...
        <div className="flex-1 p-6 md:p-10 bg-gray-900">
            <div className="mx-auto max-w-2xl">
                <div className="space-y-6">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-50">Google Spreadsheet</h1>
                        <p className="text-gray-400">
                            This form is designed to gather information about your experience with Google Spreadsheet.
                        </p>
                    </div>
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <Select id="ability-to-learn-rating" onChange={(e) => setRating1(e.target.value)}>
